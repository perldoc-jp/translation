...
取り除かれる予定です。マルチスレッド化されたコードは新しい ithread モデルに
...
ことがよく起こり、常に less lossy arithmetics になります。
...
しかし、autovivification のような tied/magical 配列やハッシュの場合は
...
上書きときがあるようです。古い Perl 共有ライブラリを以下のようにして
外すことが出来ます:

...
=end original
    ...
    $subref = sub : ATTRS SIG BLOCK;     # 属性とシグネチャ付き
...
L<B::Deparse> によるものです; C<1> を返す二つのサブルーチンの例を考えると、
...
他の方法、例えば明示的な C<return> の追加によってインライン展開機構を

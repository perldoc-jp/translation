...
この機能を使うと C<experimental::lexical_topic> カテゴリの警告が発生します。
...
この機能を使うと C<experimental::lexical_subs> カテゴリの警告が発生します。
...
この機能を使うと C<experimental::postderef> カテゴリの警告が発生します。
...
L<perlop/Bitwise String Operators> も参照してください。
...
この機能を使うと C<experimental::bitwise> カテゴリの警告が発生します。

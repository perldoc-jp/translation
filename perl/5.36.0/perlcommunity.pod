...
the Perl Foundation (L<https://www.perlfoundation.org/>) によって
管理されている L<https://perl.org> は様々なその他のコミュニティサイトのための
記録とサービスの提供を行っています。
...
Perl の姉妹言語である (以前は Perl 6 と呼ばれていた) Raku は、
L<https://raku.org/community/> に独自のコミュニティ資源を保守しています。
...
通して協調しています。
Perl メーリングリストの最大のレポジトリは L<https://lists.perl.org> に
あります。
...
メーリングリストを設定しています。
特定のプロジェクトが L<https://lists.perl.org> に挙がっていない場合、
そのプロジェクトの特定の web サイトをチェックしています。
ほとんどのメーリングリストは L<https://nntp.perl.org/> に
アーカイブされています。
...
L<https://www.irc.perl.org>。
さらにヘルプ指向の #perl については、 L<irc://irc.libera.chat/#perl>
(L<webchat|https://web.libera.chat/#perl>) を
チェックしてください。
...
L<https://www.pm.org/> にある the international Perl Mongers directory を
チェックしてください。
...
YAPC Europe web サイト L<https://www.yapceurope.org/>。
...
Perl には二つの主な年次コンベンションがありました:
O'Reilly による The Perl Conference
...
2016 年に、YAPC は再び The Perl Conference になりました。
現在は The Perl and Raku Conference になっています。
...
大きな Perl の部分がある更なるカンファレンスフランチャイズは
Open Source Developers Conference(OSDC) でした。
最初にオーストラリアで行われ、最近イスラエルとフランスに広がりました。
さらなる情報は以下にあります:
イスラエルは L<https://www.osdc.org.il>、フランスは L<http://www.osdc.fr/>。
...
The Perl Review, L<https://www.theperlreview.com> は、ワークショップ、
ハッカソン、Perl Mongers ミーティング、その他のイベントを記録するための
web サイトと Google カレンダー
(L<https://www.theperlreview.com/community_calendar>) を管理しています。
このカレンダーは L<https://www.perl.org/events.html> で見られます。

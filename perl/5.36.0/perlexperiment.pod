...
この機能を使うと C<experimental::try> カテゴリの警告が発生します。
...
この機能を使うと C<experimental::for_list> カテゴリの警告が発生します。
...
この機能を使うと C<experimental::builtin> カテゴリの警告が発生します。
...
この機能を使うと C<builtin::defer> カテゴリの警告が発生します。
...
この機能を使うと C<builtin::extra_paired_delimiters> カテゴリの警告が発生します。

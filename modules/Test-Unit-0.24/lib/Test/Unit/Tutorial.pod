...
ここには、ユニットテストが何故有用なのか、どのようにして Test::Unit
モジュール群を使ってユニットテストを行うのなどユニットテストについての
多数のドキュメントがあるべきです。
...
Perlモジュール、ドキュメントの翻訳を行っております。
 ...
 L<http://freeml.com/ctrl/html/MLInfoForm/perldocjp@freeml.com>
 L<http://perldoc.jp/>

...
[訳補足：パッケージ内にTkを利用する例は入っていないようです。
http://search.cpan.org/src/AKARGER/Games-Cards-1.45/script/freecell.tk
http://search.cpan.org/src/AKARGER/Games-Cards-1.45/script/klondike.tk
上記アドレスにありました。
]

...
$jの内部文字列$strに設定します。Jcodeオブジェクトを繰り返し利用するときに、
...
コードに書いたものが手に入るってわけです (=What you code is what you get) :)
...
$j->nmatchを通してマッチした数を取り出すことができます;
...
$keep\dakutenが設定されているときには、濁点をそのまま
...
あなたのperlがXSをサポートしていなければ(あるいはC<perl Makefile.PL>を

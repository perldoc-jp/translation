...
perlfaq は 進化している文書です。
L<http://learn.perl.org/faq/> で最新版を読んでください。
また標準 Perl 配布にも含まれています。
...
C<perldoc> コマンドラインツールは標準 Perl 配布の一部です。
perlfaq を読むには:
...
L<https://github.com/perl-doc-cats/perlfaq/wiki> を見てください。
あなたの提案がそこになければ L<https://github.com/perl-doc-cats/perlfaq> に
issue を作るか pull request を送ってください。
...
承認されれば、変更点は L<http://learn.perl.org/faq/> を管理する
L<https://github.com/tpf/perlfaq> にマージされ、次の Perl 5 リリースで
配布されます。

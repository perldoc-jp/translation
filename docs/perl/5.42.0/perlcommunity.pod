...
There are a couple of great resources for locating workshops: the
L<websites|"Websites"> mentioned above, and the YAPC Europe
website, L<http://www.yapceurope.org/>, which is probably the best resource for
European Perl events.

=end original

ワークショップを探すための素晴らしいリソースが二つあります: 前述した
L<web サイト|"Websites">、

...
それらの二、三はいいもので、いくつかはまあまあですが、多くのものはお金を
払う価値はありません。
これらの本に関して、一部は大規模なレビュー付きで、一覧が
L<https://www.perl.org/books/library.html> にあります。
ここにそれらの本の一部を載せ、挙げられた本を推薦していることを
暗示していますが、ここに含まれていない本に意味がないとは考えないでください。
...
これらの本のほとんどは O'Reilly Online Learning
( L<https://www.oreilly.com> ) 経由でオンラインで利用可能です。
...
Perl の創造者によって書かれた重要な Perl に関するリファレンス本は、
I<Programming Perl> です:
...
=end original
 ...
 ISBN 978-1-4493-9890-3 [ebook]
 https://www.oreilly.com/library/view/-/9781449321451/
 ISBN 4873110963     (第 3 版日本語版第 1 巻)
 https://www.oreilly.co.jp/books/4873110963/
 ISBN 4873110971     (第 3 版日本語版第 2 巻)
...
ラム本は特定の作業を達成するために Perl を使うためのたくさんの例が載っている
クックブックです:
...
=end original
 ...
 ISBN 978-0-596-15888-0 [ebook]
 https://www.oreilly.com/library/view/-/0596003137/
 ISBN 4-87311-202-8 (日本語版第 1 巻)
 https://www.oreilly.co.jp/books/4873112028/
 ISBN 4-87311-203-6 (日本語版第 2 巻)
 https://www.oreilly.co.jp/books/4873112036/
...
Perl の基本を学びたいなら、リャマ本から始めると良いかもしれません; これは
あなたがプログラミング自体については既に少し知っていると仮定しています:
...
=end original
 ...
 ISBN 978-1-4920-9492-0 [ebook]
 https://www.learning-perl.com/
 ISBN 978-4-87311-824-6 (第 7 版日本語版)
...
リャマ本で始まったチュートリアルはアルパカ本に続いていて、リファレンス、
データ構造、オブジェクト指向プログラミング、モジュールといった中級の
機能を説明しています:
...
=end original
 ...
 ISBN 978-1-4493-0813-1 [ebook]
 https://www.oreilly.com/library/view/-/9781449311186/
 ISBN 4-87311-031-9 (第 3 版日本語版)
 https://www.oreilly.co.jp/books/4873110319/
...
=end original
 ...
 ISBN 978-0-596-55782-9 [ebook]
 https://www.oreilly.com/library/view/-/9780596514273/
 ISBN 4-87311-170-6 (日本語版)
 https://www.oreilly.co.jp/books/4873111706/
...
=end original
 ...
 ISBN 978-1-4493-0458-4 [ebook]
 https://www.learning-perl.com/
 ISBN 978-4-87311-567-2 (日本語版)
 https://www.oreilly.co.jp/books/9784873115672/
...
=end original
 ...
 ISBN 0-201-61571-1 [1st edition 2001]
 https://www.oreilly.com/library/view/-/0201615711/
 ISBN 4894714655 (日本語版)
 https://www.pej-hed.jp/washo/312.html
...
=end original
 ...
 ISBN 1-884777-79-1 [1st edition August 1999 & ebook]
 https://www.manning.com/conway/
 ISBN 4894713004 (日本語版)
 https://www.pej-hed.jp/washo/195.html
...
=end original
 ...
 ISBN 1-930110-00-6 [1st edition 2001 & ebook]
 https://www.manning.com/cross>
 ISBN 4894715589 (日本語版)
 https://www.pej-hed.jp/washo/376.html
...
いくつかの Perl のコンセプトが、この Jon Bentley による ACM コラムの
コレクションにあることに気付くかもしれません。
(後から出た) 有名な Perl 本のタイトルとの類似性は完全に偶然ではありません:
...
=end original
 ...
 by Jon Bentley
 ISBN 978-0-201-65788-3 [2 edition, October 1999]
 http://www.pej-hed.jp/washo/159.html [日本語版]
...
=end original
 ...
 by Jon Bentley
 ISBN 0-201-11889-0 [January 1988]
 http://www.yfcbookshelf.com/programming%27s%20books2.htm [日本語版]
...
それぞれのバージョンの Perl はリリースの時点で最新の文書を同梱しています。
これは、本の一覧のような内容について問題を引き起こします。
Perl のリリースに含まれているこの一覧が含まれた後に出版されたとてもよい
本がおそらくあるので、最新リリース版を
L<https://perldoc.perl.org/perlbook.html> でチェックできます。
...
ここで挙げた本の一部はインターネットの尺度ではほとんど古典ですが、今でも
物事を為すための現在の方法を記述しているのでこれらの本を含めています。
Perl の全てが毎日変わっているわけではありません。
多くの初心者レベルの本も同様で、基本的な機能とテクニックは現在でも有効です。
しかし、一般的には、過去 5 年以内に出版された本に制限しようとしています。
...
あなたの Perl 本が一覧になく、ここにあるべきだと思うなら、私たちに
教えてください。
L<mailto:perl5-porters@perl.org>

...
さらなる情報やアーカイブへのリンクは
L<http://lists.perl.org/list/module-authors.html> を参照してください)
に尋ねてみましょう。
...
C<L<http://pause.perl.org/>> に訪れて、"Request PAUSE Account" を選択し、
...
L<ExtUtils::MakeMaker>, L<Module::Build>, L<Module::Starter>,
L<http://www.cpan.org/>,
L<http://mathforum.org/~ken/perl_modules.html> にある、

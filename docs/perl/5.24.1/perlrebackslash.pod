...
これらは L<http://www.unicode.org/reports/tr14/> と
L<http://www.unicode.org/reports/tr29/> で定義されている
...
(L<http://www.unicode.org/reports/tr14/>) に従ってマッチングしますが、
数値表現をより良く扱うために、
(L<Example 7 of revision 35|http://www.unicode.org/reports/tr14/tr14-35.html#Example7>)
文書でカスタマイズされています。
...
Word Boundary 特性の値が "Extend" または "Format" の文字が引き続く場合、
...
例えば、日本語やタイ語のような一部の言語では、単語境界の決定には
辞書検索が必要です。

...
=end original
    ...
    perluniprops	Perl での Unicode バージョン 6.0.0 特性の一覧
...
=end original
    ...
    perl51311delta	Perl の変更点: バージョン 5.13.11
    perl51310delta	Perl の変更点: バージョン 5.13.10
    perl5139delta	Perl の変更点: バージョン 5.13.9
    perl5138delta	Perl の変更点: バージョン 5.13.8
    perl5137delta	Perl の変更点: バージョン 5.13.7
    perl5136delta	Perl の変更点: バージョン 5.13.6
    perl5135delta	Perl の変更点: バージョン 5.13.5
    perl5134delta	Perl の変更点: バージョン 5.13.4
    perl5133delta	Perl の変更点: バージョン 5.13.3
    perl5132delta	Perl の変更点: バージョン 5.13.2
    perl5131delta	Perl の変更点: バージョン 5.13.1
    perl5130delta	Perl の変更点: バージョン 5.13.0
    ...
    perl5115delta	Perl の変更点: バージョン 5.11.5
    perl5114delta	Perl の変更点: バージョン 5.11.4
    perl5113delta	Perl の変更点: バージョン 5.11.3
    perl5112delta	Perl の変更点: バージョン 5.11.2
    perl5111delta	Perl の変更点: バージョン 5.11.1
    perl5110delta	Perl の変更点: バージョン 5.11.0
...
よいかわからない場合には、まず B<-w> スイッチを試してみてください。
...
パターンマッチの技術が使えます。
Perl はテキストの走査のために最適化されてはいますが、
バイナリデータを切り刻むための多くの素晴らしいツールもあります。

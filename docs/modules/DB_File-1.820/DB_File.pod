...
tie されたハッシュや配列を使って Berkeley DB にアクセスするだけでなく、 
...
L<perlmodlib/CPAN> をご覧下さい)のディレクトリ F<modules/by-module/DB_File> で
取得することができます。
...
Berkeley DB の公式ウェブサイトは 
F<http://www.oracle.com/technology/products/berkeley-db/db/index.html> です。
...
Berkeley DB FAQ
F<http://www.oracle.com/technology/products/berkeley-db/db/index.html>)
からライセンスについての一部を示します:
...
E<lt>pmqs@cpan.orgE<gt> によって作成されました。

=begin meta

Translate: hippo2000
Update: SHIRAKATA Kentaro <argrath@ub32.org> (1.805-)
Status: completed

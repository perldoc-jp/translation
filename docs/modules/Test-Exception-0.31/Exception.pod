...
もしオプショナルでないテスト記述が渡された場合, 例外の記述のチェックに使われます.
...
覚書: このテストは何らかの理由でコードが dieしたらパスします. もし dieの原因についても気にするのであれば, throws_ok()を使ってより具体的にテストすることができます.

テスト記述はオプショナルですが, 書くことを推奨します.
...
もしこのモジュールがすべきだができていないこと(もしくはすべきでないことが行われている)があれば, 知らせてください.
